...
# python3 -m pip install tensorflow-datasets==4.1.0
...
export MODEL_DIR=gs://${YOUR_BUDGET_NAME}/openmoe_8b/checkpoint_100000 \
export OUTPUT_DIR=gs://${YOUR_BUDGET_NAME}/openmoe_8b/checkpoint_100000_eval \
export T5X_DIR="./t5x" \


python3  ${T5X_DIR}/t5x/eval.py \
  --gin_file="t5x/examples/t5/t5_1_1/examples/openmoe_large_eval_bblite.gin" \
